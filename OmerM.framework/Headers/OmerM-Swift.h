...
#ifndef OMERM_SWIFT_H
#define OMERM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OmerM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSString;

SWIFT_CLASS("_TtC5OmerM17BaseInnerResponse")
...
SWIFT_CLASS("_TtC5OmerM28CreatePaymentProcessResponse")
...
SWIFT_CLASS("_TtC5OmerM13ErrorResponse")
@interface ErrorResponse : BaseInnerResponse
- (BaseInnerResponse * _Nonnull)buildFromJSONDictWithJSONDict:(NSDictionary<NSString *, id> * _Nonnull)JSONDict SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC5OmerM19MeshulamBaseRequest")
@interface MeshulamBaseRequest : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5OmerM14InitSDKRequest")
@interface InitSDKRequest : MeshulamBaseRequest
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5OmerM15InitSDKResponse")
...
SWIFT_CLASS("_TtC5OmerM8Meshulam")
...
SWIFT_PROTOCOL("_TtP5OmerM16MeshulamDelegate_")
...
SWIFT_CLASS("_TtC5OmerM22MeshulamNetworkManager")
...
SWIFT_CLASS("_TtC5OmerM20MeshulamPopupManager")
...
SWIFT_CLASS("_TtC5OmerM26PaymentProcessResponseInfo")
@interface PaymentProcessResponseInfo : BaseInnerResponse
- (BaseInnerResponse * _Nonnull)buildFromJSONDictWithJSONDict:(NSDictionary<NSString *, id> * _Nonnull)JSONDict SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC5OmerM21SetBitPaymentResponse")
@interface SetBitPaymentResponse : BaseInnerResponse
- (BaseInnerResponse * _Nonnull)buildFromJSONDictWithJSONDict:(NSDictionary<NSString *, id> * _Nonnull)JSONDict SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC5OmerM12Transactions")
