...
public class MeshulamBaseServerResponse {
    ...
    static func initFromJSONDict(JSONDict: Dict, withInnerResponse innerResponse: BaseInnerResponse) -> MeshulamBaseServerResponse {
       
        let getInt  = MeshulamParseValidator.getIntForKey.self
        let getDict = MeshulamParseValidator.getDictionaryForKey.self
        
        let baseOuterResponse = MeshulamBaseServerResponse()
